...
Build an Android application where the player plays a puzzle game based on the N-Queens problem. The user’s goal is to place n queens on an nxn chessboard such that no two queens threaten each other (no same row, column, or diagonal).
